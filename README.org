#+TITLE: Library as a Gem -  libczmq
#+LATEX: \pagebreak

* Overview

  ~laag-libczmq~ packages [[https://github.com/zeromq/czmq][czmq]] as a Ruby Gem, using [[https://github.com/colstrom/laag][laag]].
...
* Updating this Package
  ...
  #+BEGIN_SRC shell
    git-vendor update libczmq v4.1.0
  #+END_SRC
